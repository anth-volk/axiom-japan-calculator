...
export const RESULT_COPY = {
  en: {
    ...
    heading: "Estimated national tax, contributions and benefits",
    overview: "Household result overview",
    editHousehold: "Edit household inputs",
    taxesAndContributions: "Taxes and contributions",
    enteredIncome: "Entered annual income",
    enteredIncomeNote:
      "Employment income, pension receipts, and other income entered for every household member.",
    paidTaxesAndContributions: "Your paid taxes and contributions",
    paidTaxesAndContributionsNote:
      "Estimated national income-tax liability and modeled employee contributions.",
    benefits: "Benefits",
    receivedBenefits: "Your received benefits",
    receivedBenefitsNote:
      "Estimated national benefit payments using the eligibility facts you entered.",
    finalNetIncome: "Your final total net income",
    finalNetIncomeNote:
      "Entered annual income plus modeled benefits, less modeled taxes and contributions.",
    added: "added",
    deducted: "deducted",
    equals: "equals",
    amountsByProgram: "Amounts by program",
    updating: "Updating",
    ...
    warning:
      "This is a partial estimate of net income, not a complete take-home-pay or disposable-income estimate. Inhabitant tax and health and long-term-care premiums are not encoded.",
    ...
    monthlyScheduleFor: (person: string) => `${person} monthly schedule`,
    calculationOutputs: "Calculation outputs",
    technicalDetails: "Technical calculation details",
    technicalDetailsDescription:
      "Execution information, rule references, and version details.",
    execution: "Execution",
  ...
  ja: {
    ...
    eyebrow: "Axiomの計算結果",
    heading: "国の税・保険料・給付の見積り",
    overview: "世帯の計算結果の概要",
    editHousehold: "世帯の入力を編集",
    taxesAndContributions: "税金・保険料",
    enteredIncome: "入力した年額所得",
    enteredIncomeNote:
      "すべての世帯員について入力した給与収入、公的年金収入、その他の所得です。",
    paidTaxesAndContributions: "あなたが負担する税金・保険料",
    paidTaxesAndContributionsNote:
      "国の所得税額の見積りと、モデル化された本人負担の保険料です。",
    benefits: "給付",
    receivedBenefits: "あなたが受け取る給付",
    receivedBenefitsNote:
      "入力した受給要件に基づく国の給付額の見積りです。",
    finalNetIncome: "最終的な合計手取り額",
    finalNetIncomeNote:
      "入力した年額所得に、モデル化された給付を加え、税金・保険料を差し引いた額です。",
    added: "加算",
    deducted: "控除",
    equals: "等しい",
    amountsByProgram: "制度別の金額",
    updating: "更新中",
    ...
    warning:
      "これは手取り額の部分的な見積りであり、完全な手取り額や可処分所得ではありません。住民税、医療保険料、介護保険料はエンコードされていません。",
    breakdown: "規則別の内訳",
    ...
    monthlyScheduleFor: (person: string) => `${person}の月別推移`,
    calculationOutputs: "計算結果の項目",
    technicalDetails: "技術的な計算詳細",
    technicalDetailsDescription:
      "実行情報、規則の参照先、バージョン情報を表示します。",
    execution: "実行方式",
    reproducibility: "再現性",
    rules: "規則",
    engine: "エンジン",
